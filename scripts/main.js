$(function() {
    ...
    $.getJSON("config.json", function(json) {
        ...
        iosocket.on('winner', function(data) {
            ...
            $('#hover').append('<a href="leader-board.html" class="left top-scores">Top Scores</a><img class="logo" src="images/liblabstamp.png"> <a href="http://librarylab.law.harvard.edu" class="right">A Harvard Library Innovation Lab Project</a>');
            $('#main').addClass('light');
            $('#hover').show();
